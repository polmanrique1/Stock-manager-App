            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                    ...
                    {warehouses.map(warehouse => (
                        <div
                            key={warehouse.id}
                            className="bg-white p-6 shadow-lg rounded-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-gray-100"
                        >
                            ...
                            <h1 className="text-blue-700 text-xl font-bold mb-2 text-center">
                                {warehouse.name}
                            </h1>
                            ...
                            <p className="text-gray-500 font-semibold mt-3 mb-1">
                                Contact:
                            </p>
